...
def forward_pass(io):
    ...
    print
    print "Saving Features : ",str(sys.argv)[3],"\n"
#    np.save('Data/features', prob)
    np.save(str(sys.argv[3]), prob)
...
if __name__ == "__main__":
    ...
    if len(sys.argv)!=4:
        print("The correct syntax is: python convfeatures.py 'image_folder_path' 'captions_file' 'feature_save_path'")
        exit(0)
